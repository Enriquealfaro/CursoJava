...
public class PruebaJPQL {
    ...
    public static void main(String[] args) {
        ...
        log.debug("no. de personas con nombre distintos: " + contador);
        ...
        //10. Obtiene el objeto persona con id igual al paramentro proporcionado
        log.debug("\n10. Obtiene el objeto persona con id igual al paramentro proporcionado");
        int idPersona = 12;
        ...
        //11. Obtiene las personas que contienen las letra a en el nombre sin importar si es minusculo o mayuscula
        log.debug("\n//11. Obtiene las personas que contienen las letra a en el nombre sin importar si es minusculo o mayuscula");
        jpql = "select p from Persona p where upper(p.nombre) like upper(:parametro)";
        String parametroString = "%a%";//caracter que utilizamos para el like
        q = em.createQuery(jpql);
