...
public class PersonaBean {
    ...
    public PersonaBean(){
        log.debug("Iniciando el constructor de personaBeans");
    }
    ...
    log.debug("people list - select all: " + this.personas);
    ...
    public String toString() {
        return "PersonaBean{" + "personaService=" + personaService + ", personaSeleccionada=" + personaSeleccionada + '}';
    }
