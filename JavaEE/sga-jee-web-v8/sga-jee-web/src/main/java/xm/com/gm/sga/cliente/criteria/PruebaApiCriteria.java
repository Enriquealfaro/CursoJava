package xm.com.gm.sga.cliente.criteria;
...
public class PruebaApiCriteria {
    ...
    public static void main(String[] args) {
        ...
        log.debug("\n1-a. Consulta de la persona");
        //Query utilizar el API de Criteria
        ...
        //Paso5. Creamos el query typedSafe
        query = em.createQuery(criteriaQuery);

        //Paso6. Ejecutamos la conlsulta
        personas =query.getResultList();
//        mostrarPersonas(personas);

        //2-a Consulta de la persona con id=1
        // jpql = "Select p from Persona p where p.idPersonas = 1"
